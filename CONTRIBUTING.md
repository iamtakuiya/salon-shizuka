...
Thanks for helping improve the project. This guide keeps changes predictable for future collaborators and makes review easier.
The docs mirror lives at [docs/CONTRIBUTING.md](docs/CONTRIBUTING.md).

## Before you start

- Read the [documentation index](docs/README.md) to find the right subsystem.
